package com.appusuarios.testservlets;
...
public class TestServicioUsuarios {
    ...
    public void crearUsuariosValidos() {
        Usuario u1 = srvUsu.crear("ayyyyyyyyy@hotmail.miau", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("ayyyyyyyyy@hotmail.miau2", "1234", "Nom B", "30");
        Usuario u3 = srvUsu.crear("a@ee.a2", "e1234", "Nom C", "40");

        assertTrue(srvUsu.leerUno("ayyyyyyyyy@hotmail.miau").getId() > 0);
        assertEquals("Nom B", srvUsu.leerUno("ayyyyyyyyy@hotmail.miau2").getNombre());
    ...
    public void modificacionesInvalidasDeUsuarios() {
        Usuario u1 = srvUsu.crear("ayyyyyyyyy@hotmail.miauaa", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("ayyyyyyyyy@hotmail.miau2", "1234", "Nom B", "30");

        srvUsu.modificar(u1.getId(), "@dfdf", u1.getPassword(), u1.getNombre(), "25");
        assertEquals(20, srvUsu.leerUno("ayyyyyyyyy@hotmail.miauaa").getEdad());

        srvUsu.modificar(u2.getId(), "psdee.dd", u2.getPassword(), u2.getNombre(), "30");
        assertEquals("ayyyyyyyyy@hotmail.miau2", srvUsu.leerUno(u2.getId()).getEmail());
        srvUsu.eliminar(u1.getId());
        srvUsu.eliminar(u2.getId());
    }
    ...
    public void modificarUsuariosValidos() {
        ...
        assertEquals(25, srvUsu.leerUno("ayyyyyyyyy@hotmail.miau").getEdad());
    ...
    public void eliminarUsuarios() {
        ...
        assertNull(srvUsu.leerUno("ayyyyyyyyy@hotmail.miau"));
    ...
    public void listarTodos() {
        ...
        listaCreados.add(srvUsu.crear("ayyyyyyyyy@hotmail.miau", "1234", "Nom A", "20"));
        listaCreados.add(srvUsu.crear("ayyyyyyyyy@hotmail.miau2", "1234", "Nom B", "30"));
        ...
        for (Usuario usuario1 : listaCreados) {
            if (usuario1!=null && listaTotal.contains(usuario1)) {
                ...
                fail("No se ha añadido o no se encontro en lista total");
            }
        }
    }
}
